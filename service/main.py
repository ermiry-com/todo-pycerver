...
def todo_set_todo_routes (http_cerver):
	...
	cerver.http_route_set_decode_data (items_route, todo_user_parse_from_json, todo_user_delete)
	cerver.http_route_child_add (todo_route, items_route)
	...
	cerver.http_route_set_decode_data (item_info_route, todo_user_parse_from_json, todo_user_delete)
	cerver.http_route_child_add (todo_route, item_info_route)
	...
	cerver.http_route_set_decode_data (item_update_route, todo_user_parse_from_json, todo_user_delete)
	cerver.http_route_child_add (todo_route, item_update_route)
	...
	cerver.http_route_set_decode_data (item_remove_route, todo_user_parse_from_json, todo_user_delete)
	cerver.http_route_child_add (todo_route, item_remove_route)
